# -*- coding: utf-8 -*-
"""
Created on Fri May 30 15:45:38 2014
...
# -*- coding: utf-8 -*-
"""
In this version, I want the output in the SIMAP format XML, rather than the BLAST XML
 that is compatible (except for the header!) with the python BLAST parser.

For details regarding the java access to SIMAP, see here:
E:\Stephis\Projects\Programming\Python\programs\eaSimap_MT_notes.txt
Created on Fri Oct 25 17:45:09 2013
@author: m.teese
"""

'''define "run_command" 
This will run commands from python as if it was a normal windows console.
...
import tarfile
'''
***********************The files are now saved. Let's open the feature table.******************

First define the records (assuming that the simap script was run in a different session)
'''
acceptable_number_of_gaps_in_TMD = 2
#from Bio import SeqIO
import csv  
...
#set up a function for showing object names, in order to write the csv header
...
def regular_expression_search_string(inputseq):
    #in regular expressions, '-*' is interpreted as any number of '-' symbols
    #here I want to insert '_*' in between every amino acid in the TMD, to represent gaps
    search_string = ''
