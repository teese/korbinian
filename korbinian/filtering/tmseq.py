...
def run_filtering(pathdict, s, logging):
    """From the list of proteins in csv format, execeute TMSEQ transmembrane protein prediction
    ...
    """
    logging.info("~~~~~~~~~~~~                 starting running filtering: TMSEQ                 ~~~~~~~~~~~~")
    ...
    logging.info("~~~~~~~~~~~~                 finished filtering: TMSEQ                 ~~~~~~~~~~~~")
