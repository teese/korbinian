...
def calculate_gap_densities(p):
    ...
    if s["overwrite_previous_gap_analysis"] == True:
        logging.info(acc)
        ...
        for tmd in list_of_TMDs:
            ...
            outdict["%s_occuring_gaps"%tmd]=str(unique_list_of_gaps_in_tmd)
            outdict["%s_amount_possible_gappositions"%tmd]=len(unique_list_of_gaps_in_tmd)

            outdict['juxta_%s_intracellular_possible_gappositions'%tmd] = str(unique_list_of_gaps_intracellular)
