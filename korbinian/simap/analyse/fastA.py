...
def filter_and_save_fastA(df, dfs, acc, TMD, set_, tar_out, logging):
    ...
    if set_["fa_X_allowed_in_full_seq"] == True:
        ...
        fa_X_allowed_in_sel_seq = set_["cr_X_allowed_in_sel_seq"]
    ...
    for s in fasta_savelist:
        ...
        with open(fasta_file_path, 'w') as f:
            ...
            #     f.write('>%04d_%s_%s\n%s\n' % (1, str(nr_dfs_fa.loc[0, 'A2_organism'])[:30],
            #                                    str(nr_dfs_fa.loc[0, 'A4_description'])[:30],
