...
def calc_AAIMON_aa_prop_norm_factor(obs_aa_ident_full_protein, rand_TM, rand_nonTM, fraction_TM_residues=0.3):
...
def OLD_calc_AAIMON_aa_prop_norm_factor(aa_ident, rand_TM, rand_nonTM):
    """OLD method, assuming TM and nonTM can have different underlying real AA subst. rates.
